...
/*
    ...
    Vamos a crear un arreglo de arreglos con las posibles pos ganadoras
    Dentro ed la función crear un arreglo que recorra ese arreglo de arreglos
...
function validarGanador(){
    ...
    for (let index = 0; posiblesGanes < array.length; index++) {
        const [posicion,posicion2,posicion3] = posiblesGanes [index];
       if (posiblesGanes [posicion].textContent !=="" && posiblesGanes[posicion]=== posiblesGanes[posicion2].textContent && posiblesGanes[posicion].textContent===posiblesGanes [posicion3]) {
